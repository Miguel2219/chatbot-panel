...
import { RoleResponse, ModulePermissions, PermissionCheck } from '../../interfaces/role.interface';
...
export class RolesComponent implements OnInit {
  ...
  getPermission(module: ModulePermissions, action: string): PermissionCheck | undefined {
  ...
  getGrantedCount(module: ModulePermissions): number {
